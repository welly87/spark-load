...
wget https://repo1.maven.org/maven2/mysql/mysql-connector-java/8.0.14/mysql-connector-java-8.0.14.jar

spark-shell --driver-class-path mysql-connector-java-8.0.14.jar --jars mysql-connector-java-8.0.14.jar --packages org.apache.kudu:kudu-spark2_2.11:1.12.0  --master local[*] --conf spark.driver.bindAddress=127.0.0.1 --conf spark.driver.host=127.0.0.1 --conf spark.driver.port=7777